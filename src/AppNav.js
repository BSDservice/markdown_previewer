          ...
          spaicing={10}>
            <Grid item>
                <ButtonGroup variant="text" color="primary" aria-label="text primary button group">
                    <Button onClick={function(){props.changeVisibility.window='editor'; props.changeVisibility()}}>Editor</Button>
                    <Button onClick={function(){props.changeVisibility.window='viewer'; props.changeVisibility()}}>Viewer</Button>
                </ButtonGroup>
            </Grid>
